...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/andrewlaskey/Documents/Personal/github/neighborhoodai/.data/kv"}));
...
const _lazy_9cPhE0 = () => import('../index.mjs');

const handlers = [
  { route: '/', handler: _lazy_9cPhE0, lazy: true, middleware: false, method: undefined }
];
